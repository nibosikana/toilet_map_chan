...
def handle_location(event):
    ...
    cur.execute("CREATE TABLE test (id serial PRIMARY KEY, num integer, data varchar(100)[]);")
    cur.execute("INSERT INTO test (num, data) VALUES (%s, %s)", (200, ARRAY['Black', 200, 'Blue']))
